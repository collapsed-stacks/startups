...
[Source](https://gist.github.com/isaacsanders/1653078)
...
I'll try to give here an answer to the specific question that is: 
at a founding stage, how you split equities in a fair way? 
Connor's answer, although exhaustive, covers the entire equity distribution in the company lifespan and overlook the equity split process between funders.
...
Now be aware that this is my personal way to see the problem. 
...
Be clear and having a fair framework in place helps more to the morale itself than the ending share %, as long as everyone perceived this as fair.
...
**10 tokens to each founder.**
You acknowledge here that being a founder is not just a pure expertise matter. Is a behavioral condition, and a state of mind. That's why you are more keen to startup with a friend and less with a completely stranger.

**5 tokens to MVP key contributors.**
...
**3 tokens to the IDEA owner.**
That's my personal take, an idea is nothing without execution. It's harsh, but is true. An idea is just an idea. 3 tokens are enough

**1 token per 2y of experience in a field that matter for the startup core business.**
If your cofounder is a banker and you are developing the next trading platform, you need to acknowledge the fact that he's brining not direct expertise to the MVP, but a potential network, as well as industry insight.
...
* Each co-founder gets **4 shares** per day of work on the project.
* The person with the idea gets **100 shares**.
* We divide up the project into three main tasks.

 - The person with the most difficult and most important task receives **500 shares**.
 - The second most difficult is worth **350 shares**.
 - And the third most difficult is worth **250 shares**.
