## Excellent user feedback but sales still low, what am I doing wrong?

- posted by: [Nurgo](https://stackexchange.com/users/224971/nurgo) on 2014-12-17
- tagged: `marketing`, `software`, `sales`, `advertising`
- score: 26

I developed a [desktop application for Windows][1] and I'm now trying to sell it.
...
I only looked very briefly at your site, but based on the question I think you're on the right track and just need a nudge in the right direction.
...
Here are some critiques, hope they help you:

 - I don't know anything about your company / software, and when I visit your homepage, it's not clear within "*15 secs*" *what your product is* and *what it does*. 
...
Without knowing more of your metrics and what's driving traffic, it's hard to know whether the figures you quote are good, bad or indifferent. So my suggestions carry a health warning.
...
As per my understanding the ratios are good.

You should try to bring targeted customers to your site. Targeted customers will increase profit and sales ratios.

Use your home page to describe the product as you have done on the [product page](http://www.nurgo-software.com/products/aquasnap).
...
Yes I think you need to take care of some points while tackling these kinds of issues in the business
...
Can you add more flexibility for bulk purchases?  You hate a site license, but thats a fixed rate.  Maybe offer more than 5 users a 10% discount, 25 users, 20% discount, over 50 users, 50% discount or something like that.
...
<p>Retargeting costs pennies compared to traditional PPC advertising (adwords).</p>
